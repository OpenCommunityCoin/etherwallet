...
ONBOARD_bank_content__2         :  '은행은 개인 정보, 비번, 잔고 및 트랜젝션과 당신의 돈을 보존합니다.',
...
ONBOARD_blockchain_content__4   :  '블록체인의 블록은 다양한 지갑, MyEtherWallet, MetaMask, Exodus, Mist, Geth, Parity 및 그밖의 것을 통해 전송된 개별 트랜젝션으로 구성됩니다.',
...
ONBOARD_why_content__5          :  '거래 되돌리기, 취소 혹은 트랜젝션 재입금.',
...
/* New Generics */
x_CancelReplaceTx           : '트랜젝션 취소 혹은 교체',
x_CancelTx                  : '트랜젝션 취소',
...
GEN_Help_13                 : '키스토어 파일을 어떻게 백업하기 ',
GEN_Help_14                 : '여러가지 다른 포맷은? ',
GEN_Help_15                 : '자금을 잃거나 혹은 도난방지 하기.',
...
GAS_PRICE_Desc              : '가스 가격은 가스 단위당 지불할 금액입니다. `TX 수수료 = 가스 가격 * 가스 한도`, 그리고  TX를 포함한 블록을 채굴한 채굴자에게 수수료가 지급됩니다. 높은 가스 가격 = 트랜젝션은 빨라지나 가격은 비쌈. 기본값은 `41 GWEI`.',
...
NONCE_Desc                  : 'nonce는 주어진 주소에소 보낼 TX의 회수입니다. 이는 트랜젝션이 순차적으로 이루어지고 한번 이상 이루어지지 않도록 보장해줍니다.',
...
/* Footer */
FOOTER_1                    : '자유롭게 쓸 수 있는 무료 오픈소스 클라이언트 인터페이스로서, 이더리움 지갑 생성 등을 지원합니다. 이더리움 블록체인과 쉽고 안전하게 상호 작용하세요. 지갑을 열기 전에 URL(myetherwakket.com)을 다시한번 확인하세요. ',
FOOTER_1b                   : '개발자 ',
...
ERROR_35                    : '(error_35) Input address is not checksummed. <a href="https://myetherwallet.github.io/knowledge-base/addresses/not-checksummed-shows-when-i-enter-an-address.html" target="_blank" rel="noopener noreferrer"> More info</a>', // 35
...
ERROR_40                    : '(error_40) Please enter a valid private key',
